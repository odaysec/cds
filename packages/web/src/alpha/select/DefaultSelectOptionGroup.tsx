...
type DefaultSelectOptionGroupBase = <
  ...
  <Type extends SelectType = 'single', SelectOptionValue extends string = string>({
    ...
    return (
      <VStack
        ...
        ariea-disabled={disabled}
        className={cx(classNames?.optionGroup)}
        role="group"
...
export const DefaultSelectOptionGroup =
  DefaultSelectOptionGroupComponent as DefaultSelectOptionGroupBase;
